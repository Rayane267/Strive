module.exports = {
  ...
  // Sentry, Apple auth, masked-view) pour que Babel les transforme avant exécution des tests.
  transformIgnorePatterns: [
    'node_modules/(?!((jest-)?react-native|@react-native(-community|-masked-view)?|@react-navigation|@sentry|@react-native-firebase|@react-native-google-signin|@invertase|react-native-.*)/)',
  ],
