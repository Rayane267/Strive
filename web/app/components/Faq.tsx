...
const faqs = [
  ...
  { q: 'Strive marche avec quelles apps de course ?', a: 'Uber, Bolt, Heetch et toutes les apps VTC qui affichent l\'offre à l\'écran. Strive scanne n\'importe quelle capture pour en extraire les détails.' },
  { q: 'Comment fonctionne l\'essai gratuit de 3 jours ?', a: 'Les 3 premiers jours sont 100% gratuits. Annule à tout moment avant la fin de la période et tu ne seras pas facturé. Sinon, l\'abonnement se renouvelle automatiquement.' },
